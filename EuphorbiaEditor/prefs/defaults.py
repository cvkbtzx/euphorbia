...
DEFAULT_PREFS = [
    ...
    ["print_1header_font", None, 'font', "Monospace 8", None],
    ...
    ["print_2footer_font", None, 'font', "Monospace 8", None],
    ...
    ["print_linesfont", None, 'font', "Monospace 6", None],
    ["print_linesinterval", None, 'int,0,50', 5, None],
